 ...
 * having two endpoints and as a fictional 3D plane extending verticaly. The
 * Plane is then used for spanning and point clasification tests. A Normal
...
class Line2D implements Savable {
    ...
    /**
     * 'normal' of the ray. a vector pointing to the right-hand side of the line
    ...
    /**
     *
     * Determines the signed distance from a point to this line. Consider the
     * line as if you were standing on PointA of the line looking towards
     * PointB. Posative distances are to the right of the line, negative
     * distances are to the left.
     */
    ...
    /**
     * Determines where a point lies in relation to this line. Consider the line
     * as if you were standing on PointA of the line looking towards PointB. The
     * incomming point is then classified as being on the Left, Right or
    ...
    /**
     * this line A = x0, y0 and B = x1, y1 other is A = x2, y2 and B = x3, y3
     *
     * @param other
    ...
    /**
     * Determines if two segments intersect, and if so the point of
     * intersection. The current member line is considered line AB and the
     * incomming parameter is considered line CD for the purpose of the utilized
     * equations.
     *
     * A = PointA of the member line B = PointB of the member line C = PointA of
     * the provided line D = PointB of the provided line
     */
    @Deprecated
